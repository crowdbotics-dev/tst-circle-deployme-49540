...
## Project Structure
    ...
    ├── tst_circle_deployme_49540  # Django project configurations
...
1. Clone this repo and `cd tst_circle_deployme_49540`
...
2. Clone this repo and `cd tst_circle_deployme_49540`
